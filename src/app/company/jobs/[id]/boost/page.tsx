      ...
      <main className="max-w-xl mx-auto px-4 py-8 space-y-6">
        ...
        {requested === "1" && (
          <div className="bg-green-50 border border-green-200 rounded-lg px-4 py-3 text-sm text-green-700">
            Boost request received. Send payment receipt to <a href="mailto:tyngjun123@gmail.com" className="underline">tyngjun123@gmail.com</a> and we'll activate within 1 business day.
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-xl p-5 text-sm text-gray-600 space-y-2">
              ...
              <ol className="list-decimal list-inside space-y-1">
                ...
                <li>Email receipt to <a href="mailto:tyngjun123@gmail.com" className="text-blue-600 hover:underline">tyngjun123@gmail.com</a></li>
