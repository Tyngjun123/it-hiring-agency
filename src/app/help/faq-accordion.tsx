...
const ALL_FAQS: FAQItem[] = [
  ...
  { category: "Employers", q: "Can I search for candidates directly?", a: "Paid plans receive a curated IT talent list each month — 10–20 candidates on Pro and 50–80 on Max. Max also gets priority access to new candidates and a talent matching priority queue." },
